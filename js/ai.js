...
const alphabeta = (board, depth, alpha, beta, maximizingPlayer, startTime, timeLimit, lastMove, initMoves, init) => {
    ...
    if (maximizingPlayer) {
        ...
        for (let move of moves) {
            ...
            let [_, score] = alphabeta(board, depth - 1, alpha, beta, false, startTime, timeLimit, move, null, false);
        ...
        for (let move of moves) {
            ...
            let [_, score] = alphabeta(board, depth - 1, alpha, beta, true, startTime, timeLimit, move, null, false);
...
const minimax = (board, startTime, timeLimit) => {
    ...
    do {
        ...
        let [move, score] = alphabeta(board, depth, -Infinity, Infinity, true, startTime, timeLimit, null, initMoves, true);
